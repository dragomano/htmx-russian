...
description: Атрибут `hx-disabled-elt` в htmx позволяет указать элементы, к которым будет временно добавляться атрибут `disabled` на время выполнения запроса.
