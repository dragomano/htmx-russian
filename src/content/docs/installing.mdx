...
Скачайте `htmx.min.js` с [unpkg.com](https://unpkg.com/htmx.org@2/dist/htmx.min.js) и добавьте его в соответствующий каталог вашего проекта, а затем подключите в нужном места с помощью тега `<script>`:
...
<PackageManagers pkg="htmx.org@2" />
